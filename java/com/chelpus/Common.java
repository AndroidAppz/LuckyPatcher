...
public class Common {
    ...
    public static final boolean JB_MR1_NEWER = (SDK >= 17 ? true : LOLLIPOP_NEWER);
    public static final boolean JB_MR2_NEWER = (SDK >= 18 ? true : LOLLIPOP_NEWER);
    public static final boolean JB_NEWER = (SDK >= 16 ? true : LOLLIPOP_NEWER);
    public static final boolean KITKAT_NEWER = (SDK >= 19 ? true : LOLLIPOP_NEWER);
    ...
    public static final String PACKAGE_NAME = listAppsFragment.class.getPackage().getName();
    ...
    public static final int SDK = VERSION.SDK_INT;
    ...
    static {
        String str;
        boolean z = true;
        if (SDK < LATEST_ANDROID_RELEASE) {
            z = LOLLIPOP_NEWER;
        }
        LOLLIPOP_NEWER = z;
        if (LOLLIPOP_NEWER) {
            str = "com.android.server.devicepolicy.DevicePolicyManagerService";
        } else {
            str = "com.android.server.DevicePolicyManagerService";
        }
