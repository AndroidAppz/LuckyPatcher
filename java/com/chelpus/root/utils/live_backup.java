...
public class live_backup {
    ...
    public static void main(String[] var0) {
        ...
        var1_1 = live_backup.dalvikDexIn.replace((CharSequence)"zamenitetodelo", (CharSequence)var0[0]);
        try {
            ...
            Utils.copyFile(var5_3, new File(var5_3.getAbsolutePath().replace((CharSequence)"classes", (CharSequence)"backup")));
