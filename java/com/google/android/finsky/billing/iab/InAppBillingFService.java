...
public class InAppBillingFService extends Service {
    ...
    private final Stub mBinder = new Stub() {
        ...
        public int isBillingSupported(int apiVersion, String packageName, String type) throws RemoteException {
            Log.d(InAppBillingFService.TAG, "isBillingSupported");
            InAppBillingFService.this.startGoogleBilling();
            return InAppBillingFService.BILLING_RESPONSE_RESULT_OK;
        }
        ...
        public Bundle getSkuDetails(int apiVersion, String packageName, String type, Bundle skusBundle) throws RemoteException {
            ...
            boolean found;
            Iterator it2;
            Log.d(InAppBillingFService.TAG, "getSkuDetails");
            try {
                if (!(InAppBillingFService.this.mSetupDone || InAppBillingFService.this.skipSetupDone)) {
                    InAppBillingFService.this.connectToBilling(packageName);
                }
                new Bundle().putInt(IabHelper.RESPONSE_CODE, InAppBillingFService.BILLING_RESPONSE_RESULT_OK);
                if (!(!InAppBillingFService.this.mSetupDone || InAppBillingFService.this.mService == null || InAppBillingFService.this.skipSetupDone)) {
                    try {
                        ...
                        Bundle skuDetails = InAppBillingFService.this.mService.getSkuDetails(apiVersion, packageName, type, skusBundle);
                        ...
                        if (response != 0) {
                            ...
                            while (it.hasNext()) {
                                ...
                                if (item.getString("type").equals(InAppBillingFService.ITEM_TYPE_INAPP)) {
                                    found = false;
            ...
            if (!InAppBillingFService.this.mSetupDone || InAppBillingFService.this.mService == null || InAppBillingFService.this.skipSetupDone) {
                ...
                while (it.hasNext()) {
                    sku = (String) it.next();
                    if (type.equals(InAppBillingFService.ITEM_TYPE_SUBS)) {
                        found = false;
                    ...
                    if (type.equals(InAppBillingFService.ITEM_TYPE_INAPP)) {
                        found = false;
                        it2 = this.productIDinapp.iterator();
                        while (it2.hasNext()) {
                            if (sku.equals((String) it2.next())) {
                ...
                while (it.hasNext()) {
                    ...
                    if (w == null || w.length == 0) {
                        ...
                        if (w.length == 1) {
                            item_name = w[InAppBillingFService.BILLING_RESPONSE_RESULT_OK].replaceAll("_", " ");
                        }
                    }
                    long micro_price = Utils.getRandom(0, 99);
                    String price = "0." + micro_price;
                    it2 = new DbHelper(InAppBillingFService.this.mContext, packageName).getItems().iterator();
                    while (it2.hasNext()) {
            ...
            bundle.putInt(IabHelper.RESPONSE_CODE, InAppBillingFService.BILLING_RESPONSE_RESULT_OK);
        ...
        public Bundle getBuyIntent(int apiVersion, String packageName, String sku, String type, String developerPayload) throws RemoteException {
            ...
            intent.setClass(InAppBillingFService.this.getApplicationContext(), BuyActivity.class);
            intent.setAction(BuyActivity.BUY_INTENT);
            intent.addFlags(InAppBillingFService.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE);
            ...
            ArrayList<ItemsListItem> list = new DbHelper(InAppBillingFService.this.mContext, packageName).getItems();
            if (list.size() != 0) {
            ...
            bundle.putParcelable(IabHelper.RESPONSE_BUY_INTENT, PendingIntent.getActivity(InAppBillingFService.this.getApplicationContext(), InAppBillingFService.BILLING_RESPONSE_RESULT_OK, intent, 134217728));
            return bundle;
        }

        public Bundle getPurchases(int apiVersion, String packageName, String type, String continuationToken) throws RemoteException {
            Log.d(InAppBillingFService.TAG, "getPurchases");
            ArrayList<ItemsListItem> list = new DbHelper(InAppBillingFService.this.mContext, packageName).getItems();
        ...
        public int consumePurchase(int apiVersion, String packageName, String purchaseToken) throws RemoteException {
            Log.d(InAppBillingFService.TAG, "consumePurchase");
            return InAppBillingFService.BILLING_RESPONSE_RESULT_OK;
        }
    ...
    public void connectToBilling(final String pkgName) {
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                InAppBillingFService.this.mService = Stub.asInterface(service);
                try {
                    int response = InAppBillingFService.this.mService.isBillingSupported(InAppBillingFService.BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE, pkgName, InAppBillingFService.ITEM_TYPE_INAPP);
                    if (response != 0) {
                        System.out.println(response);
                        InAppBillingFService.this.skipSetupDone = true;
                        return;
