    ...
    public InAppBillingFService() {
        this.mBinder = new IInAppBillingService.Stub(){
            ...
            public int consumePurchase(int n, String string, String string2) throws RemoteException {
                Log.d((String)"BillingHackMirror", (String)"consumePurchase");
                return 0;
            }
            ...
            public Bundle getBuyIntent(int n, String string, String string2, String string3, String string4) throws RemoteException {
                ...
                intent.setClass(InAppBillingFService.this.getApplicationContext(), (Class)BuyActivity.class);
                ...
                ArrayList<ItemsListItem> arrayList = new DbHelper(InAppBillingFService.this.mContext, string).getItems();
                if (arrayList.size() != 0) {
                ...
                bundle.putParcelable("BUY_INTENT", (Parcelable)PendingIntent.getActivity((Context)InAppBillingFService.this.getApplicationContext(), (int)0, (Intent)intent, (int)134217728));
                return bundle;
            }
            ...
            public Bundle getPurchases(int n, String string, String string2, String string3) throws RemoteException {
                Log.d((String)"BillingHackMirror", (String)"getPurchases");
                ArrayList<ItemsListItem> arrayList = new DbHelper(InAppBillingFService.this.mContext, string).getItems();
            ...
            public int isBillingSupported(int n, String string, String string2) throws RemoteException {
                Log.d((String)"BillingHackMirror", (String)"isBillingSupported");
    ...
    public void connectToBilling(final String string) {
        ...
        mServiceConn = new ServiceConnection(){
            ...
            public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
                ...
                InAppBillingFService.this.mService = IInAppBillingService.Stub.asInterface((IBinder)iBinder);
                try {
                    int n = InAppBillingFService.this.mService.isBillingSupported(3, string, "inapp");
                    if (n != 0) {
                        System.out.println(n);
                        InAppBillingFService.this.skipSetupDone = true;
                        return;
                    }
                    if (InAppBillingFService.this.mService.isBillingSupported(3, string, "subs") == 0) {
                        // empty if block
                    }
