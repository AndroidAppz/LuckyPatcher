        ...
        for (int i = 0; i < extraDataRecords.size(); i++) {
            ...
            if (extraDataRecord != null && extraDataRecord.getHeader() == 1) {
                ...
                if (extraDataRecord.getSizeOfData() > 0) {
                    ...
                    if ((InternalZipConstants.MAX_ALLOWED_ZIP_COMMENT_LENGTH & diskNumberStart) == InternalZipConstants.MAX_ALLOWED_ZIP_COMMENT_LENGTH && counter < extraDataRecord.getSizeOfData()) {
